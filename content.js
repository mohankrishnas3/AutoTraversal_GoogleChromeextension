					...
					for(i9 = 1; i9<= line_child_count; i9++)
					{
						...
						if(anchor_index_list[k1][2] < count3)
						{
									...
									if(document.querySelector(line_childnode_selector+ " > div.kix-lineview-content > span:nth-child(2) > span > span:nth-child("+i9+")") == null)
						   {
								...
								anchor_coord.push(anchor_index_list[k1][0], line_child_span.getBoundingClientRect().x -110 + line_offset, line_child_span.getBoundingClientRect().y - 195 +window.scrollY);//paragraph_element.left + window.scrollX, paragraph_element.top + window.scrollY);
